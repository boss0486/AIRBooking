var pageIndex = 1;
var URLC = "/Development/Menu-Controller/Action";
var URLA = "/Development/MenuController";
var MenuController = {
    init: function () {
                ...
                if (result !== null) {
                    if (result.status === 200) {
                        ...
                        if (parseInt(totalPage) > 1) {
                            Paging.Pagination("#Pagination", totalPage, currentPage, MenuController.DataList);
                        }
                        return;
                    }
                    else {
    ...
    ConfirmDelete: function (id) {
        Confirm.DeleteYN(id, MenuController.Delete, null, null);
