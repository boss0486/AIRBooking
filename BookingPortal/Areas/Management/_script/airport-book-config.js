var pageIndex = 1;
var URLC = "/Management/AirportBookConfig/Action";
var URLA = "/Management/AirportBookConfig";
var AirportBookConfigController = {
    init: function () {
        AirportBookConfigController.registerEvent();
    },
    registerEvent: function () {
        $('#btnDeposit').off('click').on('click', function () {
            ...
            if (flg) {
                AirportBookConfigController.Deposit();
            }
            else {
        ...
        $('#btnSearch').off('click').on('click', function () {
            AirportBookConfigController.DataList(1);
        });
        $('#btnUpdate').off('click').on('click', function () {
            ...
            // submit
            if (flg) {
                AirportBookConfigController.Update();
            }
            else {
                Notifization.Error(MessageText.Datamissing);
            }
                ...
                if (result !== null) {
                    if (result.status === 200) {
                        ...
                        $.each(result.data, function (index, item) {
                            ...
                            //  role
                            var action = HelperModel.RolePermission(result.role, "AirportBookConfigController", id);
                            //
                        ...
                        if (parseInt(totalPage) > 1) {
                            Paging.Pagination("#Pagination", totalPage, currentPage, AirportBookConfigController.DataList);
                        }
                        return;
                    }
                    else {
...
AirportBookConfigController.init();
// supplier
$(document).on("change", "#ddlSupplier", function () {
    ...
    if (ddlSupplier === "") {
        ...
        // load customer
        AirportBookConfigController.GetCustomerBySupplierID(ddlSupplier, "", false);
    }
});
