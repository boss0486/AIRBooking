var pageIndex = 1;
var URLC = "/Management/ProductCategory/Action";
...
var ProductCategoryController = {
    ...
    registerEvent: function () {
        ...
        $('#btnSearch').off('click').on('click', function () {
            ProductCategoryController.DataList(1);
        });
        ...
        AjaxFrom.POST({
            ...
            success: function (response) {
                if (response !== null) {
                    if (response.status === 200) {
                        Notifization.Success(response.message);
                        ProductCategoryController.DataList(pageIndex);
                        return;
                    }
                    else {
                        Notifization.Error(response.message);
    ...
    ConfirmDelete: function (id) {
        Confirm.DeleteYN(id, ProductCategoryController.Delete, null, null);
    }
};
