...
var WalletCustomerSpendingHistoryController = {
    ...
    registerEvent: function () {
        $('#btnSearch').off('click').on('click', function () {
            WalletCustomerSpendingHistoryController.DataList(1);
        });
    },
                ...
                if (result !== null) {
                    if (result.status === 200) {
                        ...
                        if (parseInt(totalPage) > 1) {
                            Paging.Pagination("#Pagination", totalPage, currentPage, WalletCustomerSpendingHistoryController.DataList);
                        }
                        return;
                    }
                    else {
...
WalletCustomerSpendingHistoryController.init();