var pageIndex = 1;
var URLC = "/MenuCategory";
var URLA = "/Management/MenuCategory";
var MenuCategoryController = {
                    ...
                    if (result.status === 200) {
                        ...
                        $.each(result.data, function (index, item) {
                            ...
                            if (id.length > 0)
                                id = id.trim();
                            //  role
                            var action = HelperModel.RolePermission(result.role, "MenuCategoryController", id);
                            //
    ...
    ConfirmDelete: function (id) {
        Confirm.DeleteYN(id, MenuCategoryController.Delete, null, null);
