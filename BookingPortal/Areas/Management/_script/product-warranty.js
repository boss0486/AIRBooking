var pageIndex = 1;  
var URLC = "/Management/ProductWarranty/Action";
var URLA = "/Management/ProductWarranty";
                    ...
                    if (result.status === 200) {
                        ...
                        $.each(result.data, function (index, item) {
                            ...
                            if (id.length > 0)
                                id = id.trim();
                            //  role
                            var action = HelperModel.RolePermission(result.role, "ProductWarrantyController", id);
                            //
