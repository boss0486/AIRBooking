...
namespace WebCore.Services
{
    ...
    public class UserSettingService : EntityService<UserSetting>, IUserSettingService
    {
        ...
        //    //
        //    if (!Helper.Page.Validate.TestEmail(mail))
        ...
        //    var login = _connection.Query<Logged>(sqlQuerry, new
        //    {
        //        Email = strEmail
        //    }).FirstOrDefault();
        //    if (login == null)
        ...
        //    string strToken = Helper.Security.Token.Create(login.LoginID);
        //    if (login.IsCMSUser)
        //    {
        ...
        //        user.Password = Helper.Security.Library.Encryption256(model.Password);
