...
namespace WebCore.Services
{
    ...
    public class CMSUserRoleService : EntityService<CMSUserRole>, ICMSUserRole
    {
        ...
        //}
        //public ActionResult RoleUserSettingByUserID(CMSUserRoleModel model)
        //{
        //    _connection.Open();
        ...
        //            var userRoleService = new CMSUserRoleService(_connection);

        //            List<string> DbCMSUserRole = new List<string>();
        ...
        //            var lstDelRoleId = DbCMSUserRole.Except(roleOpion).ToList();
        ...
        //                    if (userRole == null)
        //                    {
        //                        userRoleService.Create<string>(new CMSUserRole()
        //                        {
        //                            UserID = model.UserID,
        //                            RoleID = item
        ...
        //    try
        //    {
        //        if (Helper.Current.UserLogin.LoggedModel.IsAdministrator)
        //            return true;

        //        if (string.IsNullOrEmpty(funcId))
        //            return false;
        //        var userRoleService = new CMSUserRoleService();
        //        var roleSettingService = new RoleSettingService();
        //        var lstCMSUserRole = userRoleService.GetAlls(m => m.UserID.ToLower().Equals(userId.ToLower())).ToList();
        //        if (lstCMSUserRole.Count == 0)
        //            return false;

        //        foreach (var item in lstCMSUserRole)
        //        {
        ...
        //        if (!string.IsNullOrEmpty(funcId))
        //        {
        //            string userId = Helper.Current.UserLogin.LoggedModel.ID;
        //            var userRoleService = new CMSUserRoleService();
        //            var roleSettingService = new RoleSettingService();
        //            var lstCMSUserRole = userRoleService.GetAlls(m => m.UserID.ToLower().Equals(userId.ToLower())).ToList();
        //            if (lstCMSUserRole.Count == 0)
